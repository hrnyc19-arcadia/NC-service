...
class ReviewList extends React.Component{
    ...
    componentDidMount(){
        this.setState({
            ...
            console.log('reviewsQty ',reviewsQty)
            console.log('reviewsPerPage): ',reviewsPerPage)
            console.log('Math.floor(reviewsQty/reviewsPerPage): ',Math.floor(reviewsQty/reviewsPerPage))
        })
